# PWA Japanese GD V1.1.1 架構

## 1. 產品與版本

- 產品 ID：`pwa-japanese-gd`
- 顯示版本：`V1.1.1`
- PWA Cache：`Japanese-PWA-V1_1_1`
- 備份 Schema：`1`
...
- 偏好：練習模式、題數、行別、假名類型、書寫方式及裝置版面會保存在本機，並納入完整備份。
- 響應式版面：自動以觸控裝置短邊判斷 iPhone／iPad；另提供手動版面切換。iPhone 的評分卡與下一步按鈕採正常文件順序，避免互相遮擋；iPad 寬版才使用黏附操作。
