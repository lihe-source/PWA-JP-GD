...
| `worker.js` | V1.2.12 日文提醒、Apple 錯誤辨識、失效訂閱清除與測試通知自動修復；本版未變更資料表，若要讓 Worker 根網址同步顯示新版，只需重新執行部署，不必再次初始化 D1 |
...
- V1.2.12 會記住 Google 帳號識別、首頁學習來源、JLPT 等級、每日推薦行別、上次練習模式、單字練習條件、五十音手寫設定，以及五十音讀音的假名類型、行別與重複次數；完整備份亦包含讀音答題記錄與學習偏好。
