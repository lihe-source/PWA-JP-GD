...
| `worker.js` | V1.2.5 日文提醒、Apple 錯誤辨識、失效訂閱清除與測試通知自動修復；本版必須重新部署 Worker，避免前端與 Worker 版本不一致 |
...
- V1.2.5 會記住 Google 帳號識別、首頁學習來源、JLPT 等級、每日推薦行別、上次練習模式、單字練習條件、五十音手寫行別、每字重複次數、自動發音開關與 iPhone／iPad 版面；完整備份亦包含學習偏好。
