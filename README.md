...
- 五十音讀音回饋：答對、答錯與練習結束使用和單字拼寫相同的音效；開始及切換每一題時會立即聚焦羅馬拼音輸入框，iPhone／iPad 自動彈出鍵盤。
...
手機上傳的逐步畫面路徑請見 `MOBILE_UPLOAD_GUIDE.md`；系統架構與資料隔離請見 `ARCHITECTURE_V1_2_9.md`；本版變更請見 `CHANGELOG_V1_2_9.md`。
