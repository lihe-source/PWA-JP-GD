...
既有使用者請先閱讀 `UPDATE_V1_2_13.md`。本版重點為同步資料保護、儲存錯誤處理、手寫中斷恢復、長音判定及安全更新；詳細驗證範圍見 `QA_V1_2_13.md`。
...
手機上傳的逐步畫面路徑請見 `MOBILE_UPLOAD_GUIDE.md`；系統架構與資料隔離請見 `ARCHITECTURE_V1_2_13.md`；本版變更請見 `CHANGELOG_V1_2_13.md`。
