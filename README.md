...
- 裝置版面：自動辨識 iPhone／iPad，也可手動切換；iPhone 依序顯示完整評分卡與下一步按鈕，iPad 寬版保留便利的黏附操作。
...
手機上傳的逐步畫面路徑請見 `MOBILE_UPLOAD_GUIDE.md`；系統架構與資料隔離請見 `ARCHITECTURE_V1_1_1.md`；本版變更請見 `CHANGELOG_V1_1_1.md`。
