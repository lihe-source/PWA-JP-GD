...
- 重複加深印象：每個已選假名可重複 1、2、3、5 或 10 次，再將完整題庫隨機洗牌；例如あ行 5 字 × 5 次＝25 題。
...
手機上傳的逐步畫面路徑請見 `MOBILE_UPLOAD_GUIDE.md`；系統架構與資料隔離請見 `ARCHITECTURE_V1_2_0.md`；本版變更請見 `CHANGELOG_V1_2_0.md`。
