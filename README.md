...
- 練習效能隔離：每題仍立即保存於本機，但 Google Drive 的下載、合併及序列化會等整段手寫／讀音練習結束後才執行一次，避免下一題書寫時突然卡頓。
...
手機上傳的逐步畫面路徑請見 `MOBILE_UPLOAD_GUIDE.md`；系統架構與資料隔離請見 `ARCHITECTURE_V1_2_12.md`；本版變更請見 `CHANGELOG_V1_2_12.md`。
