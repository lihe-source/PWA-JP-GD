import { mergeStudyDays } from './study-streak.js?v=V1_3_2';
import { mergeHandwritingHistory } from './japanese-learning.js?v=V1_3_2';
import { mergeKanaReadingHistory } from './kana-reading.js?v=V1_3_2';
