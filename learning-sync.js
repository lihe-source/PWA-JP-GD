import { mergeStudyDays } from './study-streak.js?v=V1_4_9';
import { mergeHandwritingHistory } from './japanese-learning.js?v=V1_4_9';
import { mergeKanaReadingHistory } from './kana-reading.js?v=V1_4_9';
