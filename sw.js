...
const CACHE_NAME = 'Japanese-PWA-V1_3_2';
const APP_SHELL = [
  './learning-sync.js?v=V1_3_2',
  './practice-lifecycle.js?v=V1_3_2',
  './storage-status-ui.js?v=V1_3_2',
  './',
  './index.html',
  './style.css?v=V1_3_2',
  './app.js?v=V1_3_2',
  './manifest.json?v=V1_3_2',
  './version.json',
  './storage.js?v=V1_3_2',
  './backup-schema.js?v=V1_3_2',
  './study-streak.js?v=V1_3_2',
  './japanese-learning.js?v=V1_3_2',
  './kana-data.js?v=V1_3_2',
  './kana-strokes.js?v=V1_3_2',
  './handwriting-engine.js?v=V1_3_2',
  './version-manager.js?v=V1_3_2',
  './chart-renderer.js?v=V1_3_2',
  './push-config.js?v=V1_3_2',
  './reminder-manager.js?v=V1_3_2',
  './daily-learning.js?v=V1_3_2',
  './kana-reading.js?v=V1_3_2',
  './jszip.min.js?v=3_10_1',
  './icon-192.png',
  './icon-512.png',
  './icon-192.png?v=V1_3_2',
  './icon-512.png?v=V1_3_2'
];
