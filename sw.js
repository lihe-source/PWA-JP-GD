...
const CACHE_NAME = 'Japanese-PWA-V1_2_7';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V1_2_7',
  './app.js?v=V1_2_7',
  './manifest.json?v=V1_2_7',
  './version.json',
  './storage.js?v=V1_2_7',
  './backup-schema.js?v=V1_2_7',
  './study-streak.js?v=V1_2_7',
  './japanese-learning.js?v=V1_2_7',
  './kana-data.js?v=V1_2_7',
  './kana-strokes.js?v=V1_2_7',
  './handwriting-engine.js?v=V1_2_7',
  './version-manager.js?v=V1_2_7',
  './chart-renderer.js?v=V1_2_7',
  './push-config.js?v=V1_2_7',
  './reminder-manager.js?v=V1_2_7',
  './daily-learning.js?v=V1_2_7',
  './kana-reading.js?v=V1_2_7',
