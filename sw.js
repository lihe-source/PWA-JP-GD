...
const CACHE_NAME = 'Japanese-PWA-V1_3_3';
const APP_SHELL = [
  './learning-sync.js?v=V1_3_3',
  './practice-lifecycle.js?v=V1_3_3',
  './storage-status-ui.js?v=V1_3_3',
  './',
  './index.html',
  './style.css?v=V1_3_3',
  './app.js?v=V1_3_3',
  './manifest.json?v=V1_3_3',
  './version.json',
  './storage.js?v=V1_3_3',
  './backup-schema.js?v=V1_3_3',
  './study-streak.js?v=V1_3_3',
  './japanese-learning.js?v=V1_3_3',
  './kana-data.js?v=V1_3_3',
  './kana-strokes.js?v=V1_3_3',
  './handwriting-engine.js?v=V1_3_3',
  './version-manager.js?v=V1_3_3',
  './chart-renderer.js?v=V1_3_3',
  './push-config.js?v=V1_3_3',
  './reminder-manager.js?v=V1_3_3',
  './daily-learning.js?v=V1_3_3',
  './kana-reading.js?v=V1_3_3',
  './jszip.min.js?v=3_10_1',
  './icon-192.png',
  './icon-512.png',
  './icon-192.png?v=V1_3_3',
  './icon-512.png?v=V1_3_3'
];
