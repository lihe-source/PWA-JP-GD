...
const CACHE_NAME = 'Japanese-PWA-V1_2_8';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V1_2_8',
  './app.js?v=V1_2_8',
  './manifest.json?v=V1_2_8',
  './version.json',
  './storage.js?v=V1_2_8',
  './backup-schema.js?v=V1_2_8',
  './study-streak.js?v=V1_2_8',
  './japanese-learning.js?v=V1_2_8',
  './kana-data.js?v=V1_2_8',
  './kana-strokes.js?v=V1_2_8',
  './handwriting-engine.js?v=V1_2_8',
  './version-manager.js?v=V1_2_8',
  './chart-renderer.js?v=V1_2_8',
  './push-config.js?v=V1_2_8',
  './reminder-manager.js?v=V1_2_8',
  './daily-learning.js?v=V1_2_8',
  './kana-reading.js?v=V1_2_8',
