...
const CACHE_NAME = 'Japanese-PWA-V1_2_9';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V1_2_9',
  './app.js?v=V1_2_9',
  './manifest.json?v=V1_2_9',
  './version.json',
  './storage.js?v=V1_2_9',
  './backup-schema.js?v=V1_2_9',
  './study-streak.js?v=V1_2_9',
  './japanese-learning.js?v=V1_2_9',
  './kana-data.js?v=V1_2_9',
  './kana-strokes.js?v=V1_2_9',
  './handwriting-engine.js?v=V1_2_9',
  './version-manager.js?v=V1_2_9',
  './chart-renderer.js?v=V1_2_9',
  './push-config.js?v=V1_2_9',
  './reminder-manager.js?v=V1_2_9',
  './daily-learning.js?v=V1_2_9',
  './kana-reading.js?v=V1_2_9',
