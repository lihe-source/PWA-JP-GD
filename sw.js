...
const CACHE_NAME = 'Japanese-PWA-V1_2_5';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V1_2_5',
  './app.js?v=V1_2_5',
  './manifest.json?v=V1_2_5',
  './version.json',
  './storage.js?v=V1_2_5',
  './backup-schema.js?v=V1_2_5',
  './study-streak.js?v=V1_2_5',
  './japanese-learning.js?v=V1_2_5',
  './kana-data.js?v=V1_2_5',
  './kana-strokes.js?v=V1_2_5',
  './handwriting-engine.js?v=V1_2_5',
  './version-manager.js?v=V1_2_5',
  './chart-renderer.js?v=V1_2_5',
  './push-config.js?v=V1_2_5',
  './reminder-manager.js?v=V1_2_5',
  './daily-learning.js?v=V1_2_5',
