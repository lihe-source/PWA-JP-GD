...
const CACHE_NAME = 'Japanese-PWA-V1_2_6';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V1_2_6',
  './app.js?v=V1_2_6',
  './manifest.json?v=V1_2_6',
  './version.json',
  './storage.js?v=V1_2_6',
  './backup-schema.js?v=V1_2_6',
  './study-streak.js?v=V1_2_6',
  './japanese-learning.js?v=V1_2_6',
  './kana-data.js?v=V1_2_6',
  './kana-strokes.js?v=V1_2_6',
  './handwriting-engine.js?v=V1_2_6',
  './version-manager.js?v=V1_2_6',
  './chart-renderer.js?v=V1_2_6',
  './push-config.js?v=V1_2_6',
  './reminder-manager.js?v=V1_2_6',
  './daily-learning.js?v=V1_2_6',
