...
const CACHE_NAME = 'Japanese-PWA-V1_2_14';
const APP_SHELL = [
  './learning-sync.js?v=V1_2_14',
  './practice-lifecycle.js?v=V1_2_14',
  './storage-status-ui.js?v=V1_2_14',
  './',
  './index.html',
  './style.css?v=V1_2_14',
  './app.js?v=V1_2_14',
  './manifest.json?v=V1_2_14',
  './version.json',
  './storage.js?v=V1_2_14',
  './backup-schema.js?v=V1_2_14',
  './study-streak.js?v=V1_2_14',
  './japanese-learning.js?v=V1_2_14',
  './kana-data.js?v=V1_2_14',
  './kana-strokes.js?v=V1_2_14',
  './handwriting-engine.js?v=V1_2_14',
  './version-manager.js?v=V1_2_14',
  './chart-renderer.js?v=V1_2_14',
  './push-config.js?v=V1_2_14',
  './reminder-manager.js?v=V1_2_14',
  './daily-learning.js?v=V1_2_14',
  './kana-reading.js?v=V1_2_14',
