...
const CACHE_NAME = 'Japanese-PWA-V1_3_4';
const APP_SHELL = [
  './learning-sync.js?v=V1_3_4',
  './practice-lifecycle.js?v=V1_3_4',
  './storage-status-ui.js?v=V1_3_4',
  './',
  './index.html',
  './style.css?v=V1_3_4',
  './app.js?v=V1_3_4',
  './manifest.json?v=V1_3_4',
  './version.json',
  './storage.js?v=V1_3_4',
  './backup-schema.js?v=V1_3_4',
  './study-streak.js?v=V1_3_4',
  './japanese-learning.js?v=V1_3_4',
  './kana-data.js?v=V1_3_4',
  './kana-strokes.js?v=V1_3_4',
  './handwriting-engine.js?v=V1_3_4',
  './version-manager.js?v=V1_3_4',
  './chart-renderer.js?v=V1_3_4',
  './push-config.js?v=V1_3_4',
  './reminder-manager.js?v=V1_3_4',
  './daily-learning.js?v=V1_3_4',
  './kana-reading.js?v=V1_3_4',
  './jszip.min.js?v=3_10_1',
  './icon-192.png',
  './icon-512.png',
  './icon-192.png?v=V1_3_4',
  './icon-512.png?v=V1_3_4'
];
