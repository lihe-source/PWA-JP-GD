...
const CACHE_NAME = 'Japanese-PWA-V1_4_5';
const APP_SHELL = [
  './learning-sync.js?v=V1_4_5',
  './practice-lifecycle.js?v=V1_4_5',
  './storage-status-ui.js?v=V1_4_5',
  './',
  './index.html',
  './style.css?v=V1_4_5',
  './app.js?v=V1_4_5',
  './manifest.json?v=V1_4_5',
  './version.json',
  './storage.js?v=V1_4_5',
  './backup-schema.js?v=V1_4_5',
  './study-streak.js?v=V1_4_5',
  './japanese-learning.js?v=V1_4_5',
  './kana-data.js?v=V1_4_5',
  './kana-strokes.js?v=V1_4_5',
  './handwriting-engine.js?v=V1_4_5',
  './version-manager.js?v=V1_4_5',
  './chart-renderer.js?v=V1_4_5',
  './push-config.js?v=V1_4_5',
  './reminder-manager.js?v=V1_4_5',
  './daily-learning.js?v=V1_4_5',
  './kana-reading.js?v=V1_4_5',
  './jszip.min.js?v=3_10_1',
  './icon-192.png',
  './icon-512.png',
  './icon-192.png?v=V1_4_5',
  './icon-512.png?v=V1_4_5'
];
