...
const CACHE_NAME = 'Japanese-PWA-V1_0_0';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V1_0_0',
  './app.js?v=V1_0_0',
  './manifest.json?v=V1_0_0',
  './version.json',
  './storage.js?v=V1_0_0',
  './backup-schema.js?v=V1_0_0',
  './study-streak.js?v=V1_0_0',
  './japanese-learning.js?v=V1_0_0',
  './kana-data.js?v=V1_0_0',
  './kana-strokes.js?v=V1_0_0',
  './handwriting-engine.js?v=V1_0_0',
  './version-manager.js?v=V1_0_0',
  './chart-renderer.js?v=V1_0_0',
  './push-config.js?v=V1_0_0',
  './reminder-manager.js?v=V1_0_0',
