...
const CACHE_NAME = 'Japanese-PWA-V1_3_8';
const APP_SHELL = [
  './learning-sync.js?v=V1_3_8',
  './practice-lifecycle.js?v=V1_3_8',
  './storage-status-ui.js?v=V1_3_8',
  './',
  './index.html',
  './style.css?v=V1_3_8',
  './app.js?v=V1_3_8',
  './manifest.json?v=V1_3_8',
  './version.json',
  './storage.js?v=V1_3_8',
  './backup-schema.js?v=V1_3_8',
  './study-streak.js?v=V1_3_8',
  './japanese-learning.js?v=V1_3_8',
  './kana-data.js?v=V1_3_8',
  './kana-strokes.js?v=V1_3_8',
  './handwriting-engine.js?v=V1_3_8',
  './version-manager.js?v=V1_3_8',
  './chart-renderer.js?v=V1_3_8',
  './push-config.js?v=V1_3_8',
  './reminder-manager.js?v=V1_3_8',
  './daily-learning.js?v=V1_3_8',
  './kana-reading.js?v=V1_3_8',
  './jszip.min.js?v=3_10_1',
  './icon-192.png',
  './icon-512.png',
  './icon-192.png?v=V1_3_8',
  './icon-512.png?v=V1_3_8'
];
