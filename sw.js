...
const CACHE_NAME = 'Japanese-PWA-V1_3_1';
const APP_SHELL = [
  './learning-sync.js?v=V1_3_1',
  './practice-lifecycle.js?v=V1_3_1',
  './storage-status-ui.js?v=V1_3_1',
  './',
  './index.html',
  './style.css?v=V1_3_1',
  './app.js?v=V1_3_1',
  './manifest.json?v=V1_3_1',
  './version.json',
  './storage.js?v=V1_3_1',
  './backup-schema.js?v=V1_3_1',
  './study-streak.js?v=V1_3_1',
  './japanese-learning.js?v=V1_3_1',
  './kana-data.js?v=V1_3_1',
  './kana-strokes.js?v=V1_3_1',
  './handwriting-engine.js?v=V1_3_1',
  './version-manager.js?v=V1_3_1',
  './chart-renderer.js?v=V1_3_1',
  './push-config.js?v=V1_3_1',
  './reminder-manager.js?v=V1_3_1',
  './daily-learning.js?v=V1_3_1',
  './kana-reading.js?v=V1_3_1',
  './jszip.min.js?v=3_10_1',
  './icon-192.png',
  './icon-512.png',
  './icon-192.png?v=V1_3_1',
  './icon-512.png?v=V1_3_1'
];
