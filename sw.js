...
const CACHE_NAME = 'Japanese-PWA-V1_2_10';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V1_2_10',
  './app.js?v=V1_2_10',
  './manifest.json?v=V1_2_10',
  './version.json',
  './storage.js?v=V1_2_10',
  './backup-schema.js?v=V1_2_10',
  './study-streak.js?v=V1_2_10',
  './japanese-learning.js?v=V1_2_10',
  './kana-data.js?v=V1_2_10',
  './kana-strokes.js?v=V1_2_10',
  './handwriting-engine.js?v=V1_2_10',
  './version-manager.js?v=V1_2_10',
  './chart-renderer.js?v=V1_2_10',
  './push-config.js?v=V1_2_10',
  './reminder-manager.js?v=V1_2_10',
  './daily-learning.js?v=V1_2_10',
  './kana-reading.js?v=V1_2_10',
