...
const CACHE_NAME = 'Japanese-PWA-V1_2_11';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V1_2_11',
  './app.js?v=V1_2_11',
  './manifest.json?v=V1_2_11',
  './version.json',
  './storage.js?v=V1_2_11',
  './backup-schema.js?v=V1_2_11',
  './study-streak.js?v=V1_2_11',
  './japanese-learning.js?v=V1_2_11',
  './kana-data.js?v=V1_2_11',
  './kana-strokes.js?v=V1_2_11',
  './handwriting-engine.js?v=V1_2_11',
  './version-manager.js?v=V1_2_11',
  './chart-renderer.js?v=V1_2_11',
  './push-config.js?v=V1_2_11',
  './reminder-manager.js?v=V1_2_11',
  './daily-learning.js?v=V1_2_11',
  './kana-reading.js?v=V1_2_11',
