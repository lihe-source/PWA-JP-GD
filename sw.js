...
const CACHE_NAME = 'Japanese-PWA-V1_2_3';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V1_2_3',
  './app.js?v=V1_2_3',
  './manifest.json?v=V1_2_3',
  './version.json',
  './storage.js?v=V1_2_3',
  './backup-schema.js?v=V1_2_3',
  './study-streak.js?v=V1_2_3',
  './japanese-learning.js?v=V1_2_3',
  './kana-data.js?v=V1_2_3',
  './kana-strokes.js?v=V1_2_3',
  './handwriting-engine.js?v=V1_2_3',
  './version-manager.js?v=V1_2_3',
  './chart-renderer.js?v=V1_2_3',
  './push-config.js?v=V1_2_3',
  './reminder-manager.js?v=V1_2_3',
