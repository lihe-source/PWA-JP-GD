...
const CACHE_NAME = 'Japanese-PWA-V1_2_12';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V1_2_12',
  './app.js?v=V1_2_12',
  './manifest.json?v=V1_2_12',
  './version.json',
  './storage.js?v=V1_2_12',
  './backup-schema.js?v=V1_2_12',
  './study-streak.js?v=V1_2_12',
  './japanese-learning.js?v=V1_2_12',
  './kana-data.js?v=V1_2_12',
  './kana-strokes.js?v=V1_2_12',
  './handwriting-engine.js?v=V1_2_12',
  './version-manager.js?v=V1_2_12',
  './chart-renderer.js?v=V1_2_12',
  './push-config.js?v=V1_2_12',
  './reminder-manager.js?v=V1_2_12',
  './daily-learning.js?v=V1_2_12',
  './kana-reading.js?v=V1_2_12',
