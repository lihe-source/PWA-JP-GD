...
const CACHE_NAME = 'Japanese-PWA-V1_2_2';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V1_2_2',
  './app.js?v=V1_2_2',
  './manifest.json?v=V1_2_2',
  './version.json',
  './storage.js?v=V1_2_2',
  './backup-schema.js?v=V1_2_2',
  './study-streak.js?v=V1_2_2',
  './japanese-learning.js?v=V1_2_2',
  './kana-data.js?v=V1_2_2',
  './kana-strokes.js?v=V1_2_2',
  './handwriting-engine.js?v=V1_2_2',
  './version-manager.js?v=V1_2_2',
  './chart-renderer.js?v=V1_2_2',
  './push-config.js?v=V1_2_2',
  './reminder-manager.js?v=V1_2_2',
