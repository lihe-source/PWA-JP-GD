...
const CACHE_NAME = 'Japanese-PWA-V1_2_4';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V1_2_4',
  './app.js?v=V1_2_4',
  './manifest.json?v=V1_2_4',
  './version.json',
  './storage.js?v=V1_2_4',
  './backup-schema.js?v=V1_2_4',
  './study-streak.js?v=V1_2_4',
  './japanese-learning.js?v=V1_2_4',
  './kana-data.js?v=V1_2_4',
  './kana-strokes.js?v=V1_2_4',
  './handwriting-engine.js?v=V1_2_4',
  './version-manager.js?v=V1_2_4',
  './chart-renderer.js?v=V1_2_4',
  './push-config.js?v=V1_2_4',
  './reminder-manager.js?v=V1_2_4',
