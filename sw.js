...
const CACHE_NAME = 'Japanese-PWA-V1_3_0';
const APP_SHELL = [
  './learning-sync.js?v=V1_3_0',
  './practice-lifecycle.js?v=V1_3_0',
  './storage-status-ui.js?v=V1_3_0',
  './',
  './index.html',
  './style.css?v=V1_3_0',
  './app.js?v=V1_3_0',
  './manifest.json?v=V1_3_0',
  './version.json',
  './storage.js?v=V1_3_0',
  './backup-schema.js?v=V1_3_0',
  './study-streak.js?v=V1_3_0',
  './japanese-learning.js?v=V1_3_0',
  './kana-data.js?v=V1_3_0',
  './kana-strokes.js?v=V1_3_0',
  './handwriting-engine.js?v=V1_3_0',
  './version-manager.js?v=V1_3_0',
  './chart-renderer.js?v=V1_3_0',
  './push-config.js?v=V1_3_0',
  './reminder-manager.js?v=V1_3_0',
  './daily-learning.js?v=V1_3_0',
  './kana-reading.js?v=V1_3_0',
  './jszip.min.js?v=3_10_1',
  './icon-192.png',
  './icon-512.png',
  './icon-192.png?v=V1_3_0',
  './icon-512.png?v=V1_3_0'
];
